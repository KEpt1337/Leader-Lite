...
import leader.module.modules.movement.InvWalk;
...
public class AutoAnduril extends Module {
    ...
    public boolean canSwap() {
        ...
        InvWalk invWalk = (InvWalk) Leader.moduleManager.modules.get(InvWalk.class);
        return mc.currentScreen == null || mc.currentScreen instanceof leader.ui.ClickGui
