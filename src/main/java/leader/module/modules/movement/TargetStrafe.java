...
import leader.module.modules.movement.Fly;
import leader.module.modules.movement.LongJump;
import leader.module.modules.movement.Speed;
...
public class TargetStrafe extends Module {
    ...
    private boolean canStrafe() {
        if (this.speedOnly.getValue()) {
            Speed speed = (Speed) Leader.moduleManager.modules.get(Speed.class);
            Fly fly = (Fly) Leader.moduleManager.modules.get(Fly.class);
