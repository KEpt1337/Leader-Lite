...
public class AccountManager {
    ...
    private static final File file = new File(mc.mcDataDir, "leader.accounts.json");
            ...
            try {
                if (file.getParentFile().exists() || file.getParentFile().mkdirs()) {
                    if (file.createNewFile()) {
                        System.out.print("Successfully created leader.accounts.json!");
                    }
                }
            } catch (IOException e) {
                System.err.print("Couldn't create leader.accounts.json!");
            }
        }
    }
    ...
    public static void load() {
        ...
        try {
            ...
            System.err.print("Couldn't find leader.accounts.json!");
        }
    }
    ...
    public static void save() {
        try {
            ...
            System.err.print("Couldn't save leader.accounts.json!");
        }
    }
}
